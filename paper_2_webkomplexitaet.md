...
**Reproduzierbarkeit:** Alle Auswertungen und beide Abbildungen erzeugt das Skript `check_web_analysis.py` aus der versionierten Merkmalsdatei `new_web_features.csv`, die exakt der Tool-Pipeline aus den Crawl-Artefakten entspricht. Zufallsentscheidungen sind dort mit festen Saaten fixiert, nur die als seed-abhängig gekennzeichneten Größen können bei anderen Saaten leicht abweichen.
