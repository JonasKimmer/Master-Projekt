...
\begin{column}{\lw}
  ...
  \begin{block}{Beitrag dieser Arbeit}
    ...
    \textcolor{primary}{\bfseries Tool\enskip}--\enskip
      Streamlit · Python · Einlesen · Export\\[0.5em]
  ...
  \begin{block}{Dauer x Frustration (r = 0,56)}
    \vspace{0.3em}
    \includegraphics[width=0.82\linewidth]{paper1_scatter_frustration.png}
  \end{block}

  \vspace{0.8em}

  \begin{block}{Dauer x Mentale Last (r = 0,03)}
    \vspace{0.3em}
    \includegraphics[width=0.82\linewidth]{paper1_scatter_mentale.png}
  \end{block}
...
\begin{column}{\lw}
  ...
  \begin{block}{3 Befunde}
    ...
    \begin{tikzpicture}
      \node[fill=primary,rounded corners=8pt,inner sep=12pt,
        ...
        \mdseries
        Unterschied: nur \textbf{1,7 Punkte}.
    ...
    \begin{tikzpicture}
      \node[fill=dark,rounded corners=8pt,inner sep=12pt,
        ...
        \mdseries
        \textbf{10 Punkte} Unterschied (6x mehr als bei mentaler Last).
    ...
    \begin{tikzpicture}
      \node[fill=warm,rounded corners=8pt,inner sep=12pt,
        ...
        Gaming: meiste Anstrengung. Stadtplanung: schlechteste Leistung.
      };
    \end{tikzpicture}
  ...
  \begin{alertblock}{Was das bedeutet}
    \vspace{0.4em}
    \large
    · Für Visualisierungsdesign zählt Klarheit, nicht das Thema\\[0.3em]
    · Bearbeitungszeit ist kein Maß für kognitive Last
    \vspace{0.4em}
  \end{alertblock}
